...
public class LogActionCommand implements TabExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        switch (args.length) {
            case 0 -> sender.sendMessage(Main.prefix + "Usage: /logaction <action: INTERACTED/OPENED/BROKE/PLACED/PICKEDUP/DROPPED/GRABBED/DIED/WASBANNED> <true/false>");
            case 1 -> {
                ...
                sender.sendMessage(Main.prefix + "Status (" + args[0].toLowerCase() + "): " + MinecraftLogger.getLogAction(Action.valueOf(args[0].toUpperCase())));
            }
            case 2 -> {
                ...
                MinecraftLogger.setLogAction(Action.valueOf(args[0]), Boolean.parseBoolean(args[1]));
